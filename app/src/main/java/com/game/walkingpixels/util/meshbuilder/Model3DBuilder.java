    ...
    public WorldVertex[] generateMobVertices(Vector3 position, Block type, float rotation){
        ...
        switch (type){
            ...
            case EYE:
                ...
                break;
            case BLUE_SLIME:
                model += "slime" + getAnimation(100, modelManager.SLIME_ANIMATIONS);
                scale = new Vector3(0.75f);
                rotation += 90;
                break;
            case GREEN_SLIME:
                model += "slimeGreen" + getAnimation(100, modelManager.SLIME_ANIMATIONS);
                scale = new Vector3(0.75f);
                break;
            case PURPLE_SLIME:
                model += "slimePink" + getAnimation(100, modelManager.SLIME_ANIMATIONS);
                scale = new Vector3(0.75f);
                rotation += 90;
                break;
            case DANGER_NOODLE:
